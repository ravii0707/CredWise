    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<User>().HasData(
            new User
            {
                ...
                Password = BCrypt.Net.BCrypt.HashPassword("Admin@123"), // BCrypt hashed password
                FirstName = "Admin",
                LastName = "System",
        ...
        modelBuilder.Entity<LoanProduct>().HasData(
            new LoanProduct
            {
                ...
                LoanType = "Personal",
                IsActive = true,
                ImageUrl = "images/loans/personal.jpg",
                CreatedAt = DateTime.UtcNow,
                ModifiedAt = DateTime.UtcNow,
                CreatedBy = "System",
                ModifiedBy = "System"
            ...
            new LoanProduct
            {
                LoanProductId = 2,
                Title = "Home Loan",
                Description = "Loan for purchasing or constructing a house",
                MaxLoanAmount = 10000000,
                LoanType = "Home",
                IsActive = true,
                ImageUrl = "images/loans/home.jpg",
                CreatedAt = DateTime.UtcNow,
                ModifiedAt = DateTime.UtcNow,
                CreatedBy = "System",
                ModifiedBy = "System"
            ...
            new LoanProduct
            {
                ...
                LoanType = "Gold",
                IsActive = true,
                ImageUrl = "images/loans/gold.jpg",
                CreatedAt = DateTime.UtcNow,
                ModifiedAt = DateTime.UtcNow,
                CreatedBy = "System",
                ModifiedBy = "System"
        ...
        // Seed FD types
        modelBuilder.Entity<Fdtype>().HasData(
            new Fdtype
            {
                FdtypeId = 1,
                Name = "Regular FD",
                Description = "Standard fixed deposit with fixed tenure and interest",
                InterestRate = 6.5m,
                MinAmount = 5000,
                MaxAmount = 1000000,
                Duration = 12,
            ...
            new Fdtype
            {
                ...
                Description = "Higher interest rate for senior citizens",
                InterestRate = 7.5m,
                MinAmount = 5000,
                MaxAmount = 1000000,
                Duration = 12,
        ...
        // All existing entity configurations remain unchanged
